...
<div id="container">
	...
	<div class="good">
		...
		<ul class="goodinfo f_l">
			...
			<li class="h74 buynow"><a href="http://localhost:8080/shop_system/productController?action=addShoppingCart&&id=<%=productInfo.getId()%>"><img src="images/buynow.gif" alt="alt" /></a></li>
