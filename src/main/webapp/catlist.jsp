<%@ page import="com.tmy.entity.ProductInfo" %>
		...
		<ul class="w50p info">
			...
			<%
				if(ProductInfoList!=null){
					for(ProductInfo productInfo : ProductInfoList){
			%>
			<li><a href="http://localhost:8080/shop_system/productController?action=showInfo&&id=<%=productInfo.getId()%>"><%=productInfo.getName()%></a><br />出售者：<a href="#"><%=productInfo.getSeller()%><br /><a href="#"><img src="images/contactme.gif" alt="alt" /> <img src="images/addfav.gif" alt="收藏" />收藏</a></li>
			<%
					}
				}
			%>
